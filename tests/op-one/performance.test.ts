...
import { knowledgeStore, opOneEpisodeStore, conversationStore } from '../../src/op-one/stores.js';
import { retrieve } from '../../src/op-one/memory.js';
import { createFakeEngine } from './fake-engine.js';
import type { OpOneEpisode } from '../../src/op-one/types.js';
...
describe('Aura OP One performance', () => {
  it('measures startup: module load and session construction', async () => {
    ...
    await import('../../src/op-one/index.js');
