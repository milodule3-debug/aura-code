...
## Ownership Statement
Aura Code (formerly Rubyness, BootstrapRuby) — the name, concept, architecture, and design are the intellectual property of Dušan Milosavljević, operating under Lean Progress IQ (lean-progress-iq-site.vercel.app).
...
Built by Dušan Milosavljević acting as lead architect and orchestrator, directing AI agents (Claude, OpenCode, Grok, Pi) to implement the design. AI agents were tools — the building belongs to the architect.
...
Dušan Milosavljević
leanproiq@gmail.com
https://lean-progress-iq-site.vercel.app
Da Nang, Vietnam
